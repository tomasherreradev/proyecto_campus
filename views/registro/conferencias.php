...
<div class="eventos-registro">
    <main class="eventos-registro__listado">    
        ...
        <p class="eventos-registro__fecha">Viernes, 15 de Octubre</p>
        ...
        <p class="eventos-registro__fecha">Sábado, 16 de Octubre</p>
    ...
    <aside class="registro">
            <h2 class="registro__heading">Tus Registros</h2>

            <div class="registro__resumen" id="registro__resumen">
                <!-- codigo de js -->
            </div>
