...
<section class="resumen">
    <div class="resumen__grid">
        <div data-aos="<?php aosAnimation(); ?>" class="resumen__bloque">
            <p class="resumen__texto--numero">
...
<section class="speakers">
    ...
    <p class="speakers__descripcion">Ellos son nuestros expertos, te los presentamos:</p>

    <div class="speakers__grid">
        <?php foreach ($ponentes as $ponente) : ?>
            <div data-aos="<?php aosAnimation(); ?>" class="speaker">
                <picture>
